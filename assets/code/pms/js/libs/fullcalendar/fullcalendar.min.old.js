...
(function (t) {
    ...
    function me(n, r) {
        ...
        function f(n) {
            ...
            var r, s, l, a, u, d = Q.defaultButtonText || {}, c = Q.buttonText || {}, h = Q.views || {}, f = n, g = [], p = !1;
            if (he[n])return he[n];
        ...
        var ee, ne, ie, re, se, oe, le, ae, ue = q.isFetchNeeded, de = q.fetchEvents, ce = n[0], he = {}, fe = 0, ge = [];
    ...
    var Re, ke, Me, Fe = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], ze = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], _e = {}.hasOwnProperty, Le = /^\s*\d{4}-\d\d$/, Pe = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, Ve = e.fn, Ge = t.extend({}, Ve);
    De.moment = function () {
        return A(arguments)
